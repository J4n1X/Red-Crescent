# Red Crescent reference

Everything a template can use, how requests are routed, every setting, and what the server
guarantees. For installing and deploying, see the [README](README.md).
...
- [Environment differences from stock Lua](#environment-differences-from-stock-lua)
- [SQLite](#sqlite)
- [Crypto](#crypto)
- [Subprocesses and files](#subprocesses-and-files)
...
|---|---|---|---|
| `--bind` | `RC_BIND` | `127.0.0.1:8080` | Address to listen on; ignored when systemd passes a socket |
